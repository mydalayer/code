...
public interface IMyDALayerPageClient extends MyDALayerClient {
	 ...
	 */
	PaginationResult<Map<String, Object>> queryForList(String sqlId,
			Object param, int offset, int limit);
	 ...
	 * @return PaginationResult，包含分页查询结果及数据行数
	 */
	<T> PaginationResult<T> queryForList(String sqlId,
			Map<String, Object> paramMap, Class<T> requiredType, int offset,
			int limit);
	 ...
	 * @return PaginationResult，包含分页查询结果及数据行数
	 */
	<T> PaginationResult<T> queryForList(String sqlId, Object param,
			Class<T> requiredType, int offset, int limit);
	 ...
	 */
	<T> PaginationResult<T> queryForList(String sqlId, Object param,
			RowMapper<T> rowMapper, int offset, int limit);
	 ...
	 */
	<T> PaginationResult<T> queryForList(String sqlId,
			Map<String, Object> paramMap, RowMapper<T> rowMapper, int offset,
			int limit);
