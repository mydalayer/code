...
public interface DalClient {
	...
	<T> T queryForObject(String sqlId, Map<String, Object> paramMap,
	 ...
	 * */
	<T> List<T> queryForList(String sqlId, Map<String, Object> paramMap,
			Class<T> requiredType);
	...
	Map<String, Object> call(String sqlId, Map<String, Object> paramMap,
